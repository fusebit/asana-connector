...
class AsanaConnector extends OAuthConnector {
   ...
   * @returns {string} Returns the id of the created webhook.
   */
  async createNewWebhook(fusebitContext, oldUserContext, asana, resourceId, options) {
    ...
    Object.assign(oldUserContext, userContext);
